package com.lara.dashboard.config;

import com.lara.dashboard.security.JwtAuthFilter;
import com.lara.dashboard.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/clinicians/approved").hasAnyAuthority("ROLE_FAMILY", "ROLE_ADMIN")
